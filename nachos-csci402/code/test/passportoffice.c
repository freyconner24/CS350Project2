  ...
  void createClerkThread(int type, int* clerkNumber) {
      ...
      for(i = 0; i < clerkArray[type]; ++i) {
          my_strcpy(clerkName, concatClerkNameWithNumber(clerkType, *clerkNumber));
          Fork((VoidFunctionPtr)ApplicationClerk/*,clerkName*/);
  ...
  void createCustomerThreads() {
      ...
      for(i = 0 ; i < customerCount; i++){
          name = concatClerkNameWithNumber("Customer", i);
          Fork((VoidFunctionPtr)Customer/*,name*/);
      }
  }
  ...
  void createSenatorThreads(){
      ...
      for(i = 0; i < senatorCount; i++){
          name = concatClerkNameWithNumber("Senator", i);
          Fork((VoidFunctionPtr)Senator/*,name*/);
      }
  }
  ...
  void createTestVariables(int countOfEachClerkType[]) {
      ...
      Fork((VoidFunctionPtr)Manager/*,name*/);
  }
